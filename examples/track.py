...
from strategy import time_synchronized
...
def run(args):
    ...
    print("total_time:{}s".format(str(total_time)), ","
          "speed:{}fps".format(str(fps/total_time)))
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='video/mot_metric_3.mp4', help='file/dir/URL/glob, 0 for webcam')
