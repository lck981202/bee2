...
def parse_opt():
    ...
    parser.add_argument('--yolo-model', type=Path, default=WEIGHTS / 'v8s_250.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--source', type=str, default='video/bee_speed.mp4', help='file/dir/URL/glob, 0 for webcam')
